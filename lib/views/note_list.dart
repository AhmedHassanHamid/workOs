...
import 'package:app_api/services/note_services.dart';
import 'package:app_api/views/note_modify.dart';
            ...
            itemBuilder: (_, index){
              return Dismissible(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('Last edited on ${formateDateTime(_apiResponse.data[index].LatestEditDateTime ??  _apiResponse.data[index].createDateTime)}'),
                  onTap:(){
                    Navigator.of(context).push(MaterialPageRoute(builder: (_) => NoteModify(noteID: _apiResponse.data[index].noteID))) .then((dtat){
                      _fetchNotes();
                    }) ;
                  } ,
                ),
